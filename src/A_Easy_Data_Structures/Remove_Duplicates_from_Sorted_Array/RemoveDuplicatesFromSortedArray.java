...
Since it is impossible to change the getLength of the array in some languages, you must instead have the result be placed in the first part of the array nums. More formally, if there are k elements after removing the duplicates, then the first k elements of nums should hold the final result. It does not matter what you leave beyond the first k elements.
...
int[] expectedNums = [...]; // The expected answer with correct getLength

int k = removeDuplicates(nums); // Calls your implementation

assert k == expectedNums.getLength;
for (int i = 0; i < k; i++) {
...
//            nums[i] = temp[i];
//        }
//        nums = Arrays.copyOfRange(temp, 0, temp.getLength);      // not works since Java is pass-by-value
//        System.arraycopy(temp, 0, nums, 0, temp.getLength);
